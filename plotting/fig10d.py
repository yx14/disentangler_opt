...
def fig10d(data_folder, save_folder):
    l = 8
    r = 8
    b = 60
    c = 12
    ...
    disentanglers = ['Alt', 'RTRN', 'Alt-iter250-RTRN', 'Alt-iter500-RTRN', 'Alt-iter1000-RTRN']
    ...
    plt.savefig(save_folder + 'fig10d.svg', bbox_inches='tight', dpi=1200, transparent=True)
    ...
    plt.xticks([0, 60])
    plt.yticks([1e-3, 1e-5])
    plt.tick_params(axis='x', which='major', pad=12)
    plt.tick_params(axis='y', which='major', pad=8)

    plt.savefig(save_folder + 'fig10d_inset.svg', dpi=1200, bbox_inches='tight', transparent=True)
