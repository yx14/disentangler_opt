...
# wall time for Alt + RTRN hybrid methods: random tensor
def fig10c(data_folder, save_folder):
    n = 12
    ...
    plt.savefig(save_folder + 'fig10c.svg', bbox_inches='tight', dpi=1200, transparent=True)
    ...
    plt.savefig(save_folder + 'fig10c_inset.svg', dpi=1200, bbox_inches='tight', transparent=True)
